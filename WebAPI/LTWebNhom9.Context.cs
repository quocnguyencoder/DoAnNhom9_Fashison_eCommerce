...
namespace WebAPI
{
    ...
    public partial class DB_A6A231_DAQLTMDTEntities : DbContext
    {
        ...
        public virtual IQueryable<User_Cart_Result> User_Cart(Nullable<int> user_id)
        {
            var user_idParameter = user_id.HasValue ?
                new ObjectParameter("user_id", user_id) :
                new ObjectParameter("user_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<User_Cart_Result>("[DB_A6A231_DAQLTMDTEntities].[User_Cart](@user_id)", user_idParameter);
        }
    }
}
