...
{
    public class Seller_ProductController : ApiController
    {
        ...
        [Route("api/Seller_Product/GetStoreid/{userID}")]
        ...
        [HttpGet]
        [Route("api/Seller_Product/GetProducts/{StoreID}")]
        ...
        [HttpGet]
        [Route("api/Seller_Product/FindProducts/filter")]
