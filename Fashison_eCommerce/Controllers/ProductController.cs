...
namespace Fashison_eCommerce.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Product_ID,Name,Price,Amount,TypeID,Store_ID,Pictures,Decription")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Product_ID,Name,Price,Amount,TypeID,Store_ID,Pictures,Decription")] Product product)
        {
            if (ModelState.IsValid)
            {
